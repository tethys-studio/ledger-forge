...
function LoginForm() {
  ...
  useEffect(() => {
    if (errorParam === 'account_not_linked') {
      setErrorMessage(
        'An account already exists with this email address. Google OAuth linking has been enabled—tap "Continue with Google" again to link and access your account.'
      );
    } else if (errorParam) {
      setErrorMessage(`Authentication notice: ${errorParam.replace(/_/g, ' ')}`);
    }
  }, [errorParam]);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-[#080C14] relative overflow-hidden">
      {/* Neo-Fintech Ambient Gradient Blurs */}
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0F172A]/75 backdrop-blur-2xl p-7 sm:p-9 shadow-2xl shadow-black/80 relative overflow-hidden">
          ...
          <div className="absolute inset-x-0 top-0 h-[1.5px] bg-gradient-to-r from-transparent via-violet-500/50 to-transparent" />
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-xs text-slate-400 mt-1 max-w-xs font-mono">
              Hyper-precise cash flow, sinking funds &amp; Udhaar intelligence
            </p>
          </div>
          ...
          {/* Single-Tap Google OAuth Button */}
          <button
            type="button"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-mono tracking-widest text-slate-400">
              <span className="bg-[#0F172A] px-3 rounded-full">Or with credentials</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="name@ledgerforge.com"
                  autoComplete="email"
                  required
            ...
            <button
              ...
              className="w-full mt-2 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 via-indigo-600 to-violet-600 bg-[length:200%_auto] hover:bg-right px-4 py-3 text-sm font-semibold text-white shadow-xl shadow-violet-600/30 hover:shadow-violet-600/50 active:scale-[0.99] transition-all disabled:opacity-50 disabled:pointer-events-none"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-xs text-slate-400">
              ...
              <Link
                ...
                className="font-semibold text-violet-400 hover:text-violet-300 underline underline-offset-4 transition-colors"
              >
                Sign up for free
              </Link>
            </p>
